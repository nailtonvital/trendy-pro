            ...
            <div className='overflow-x-auto sm:-mx-6 lg:-mx-8'>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    <thead className='bg-[#1B1A20] border-b'>
                        <tr>
                        <th scope='col' className='text-sm font-medium text-slate-100 pl-6 py-4 text-left'>
                            #
                        </th>
                        <th scope='col' className='text-sm font-medium text-slate-100 pr-6 py-4 text-left'>
                            Title
                        </th>
                        <th scope='col' className='text-sm font-medium text-slate-100 px-6 py-4 text-left'>
                            Position Last Week
                        </th>
                        <th scope='col' className='text-sm flex gap-1 font-medium text-slate-100 px-6 py-4 text-left'>
                    ...
                    <tbody>
                        {songs.map((item)=>{
                            return (<tr className='bg-[#1B1A20] border-b transition duration-300 ease-in-out hover:bg-[#26252B] '>
                            ...
                            <td className='font-bold text-slate-100 px-6 py-4 whitespace-nowrap'>
