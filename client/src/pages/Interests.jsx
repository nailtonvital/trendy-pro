                    ...
                    {results.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <td className="text-sm flex-col text-white font-bold pr-12 py-4 whitespace-nowrap">
                            {item.topic}
                          </td>
                          <td className="text-sm flex-col text-white  font-medium pr-6 py-4 whitespace-nowrapp">
                            {item.path
                              .join()
                              .replace(",", ">")
                              .replace(",", ">")
