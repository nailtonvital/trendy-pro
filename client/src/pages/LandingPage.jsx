        ...
        <div className={style.container}>
          ...
          <div id="sobe" className={style.hero}>
            <div className={style["left-hero"]}>
              ...
              <p>
                Rastreamos todos os tópicos na Internet para identificar tendências crescentes.
              </p>
          ...
          <div className={style.banner}>
            <h3 className="text-xl font-bold">Nossas principais ferramentas</h3>
            <ul>
              <li>
                <svg
                  width="80"
              ...
              <li>
                ...
                >
                  <path
                    d="M1 6V10M9 3V10M5 2V10M13 1V10"
                    stroke="white"
                    stroke-width="2"
          ...
          <div className={style.item}>
            <div className={style["left-align"]}>
              <a id="About Us"></a>
              <h3 className={style.titleHeader}>
                Saiba o que está acontecendo ao redor do mundo.
              </h3>
            </div>
          ...
          <div className="items-stretch flex mb-24 mt-80">
            ...
            <div className=" pl-60 pt-28 text-end">
              <p className="text-5xl font-bold pb-6">
                Nunca houve uma maneira tão fácil de fazer conteúdos criativos e atuais.
              </p>
              <p className="text-xl font-light">
                Foque suas energias no que realmente tem público.
              </p>
            </div>
          </div>
          ...
          <div className="items-stretch flex mb-24 mt-80">
            <div className="mt-52 text-start">
              <p className="text-5xl font-bold pb-6">
                Descobrir qual é a próxima grande tendência nos diz em que focar
              </p>
            </div>
          ...
          <div className="items-stretch flex mb-24 mt-80">
            ...
            <div className=" pl-60 pt-28 text-end w-1/2">
              <p className="text-5xl font-bold pb-6">
                Acesse as informações mais relevantes, o que é popular.
              </p>
              <p className="text-xl font-light">
                Acesso a todos os trending topics nas redes sociais
              </p>
            </div>
          </div>
          ...
          <div className={style["social-proof"]}>
            <a id="Contact"></a>
            <p className="text-3xl font-bold mt-80">Por trás dos panos...</p>
            <div className={style["social-cards"]}>
                ...
                <div className={style["social-card"]}>
                  ...
                  <div className={style["social-quote"]}>
                    <p>
                      ...
                      naturalmente desperta todo tipo de ressentimento, inveja e
                      outras manifestações de insegurança." <br></br>-Robert
                      Greene
                    </p>
                  </div>
              ...
              <a href="https://www.instagram.com/_guizen/" target="_blank">
                <div className={style["social-card"]}>
                  ...
                  <div className={style["social-quote"]}>
                    <p>
                      "Pra quem tem pensamento forte o impossível é só questão
                      de opinião"<br></br> - Charlie Brown Jr
                    </p>
                  </div>
                  <div className={style.people}>
                    <img src={campos} alt="" />
                ...
                <div className={style["social-card"]}>
                  ...
                  <div className={style["social-quote"]}>
                    <p>
                      ...
                      Vê que o inimigo ganhou?<br></br>A gente se tornou tudo
                      <br></br>
                ...
                <div className={style["social-card"]}>
                  ...
                  <div className={style["social-quote"]}>
                    <p>
                      ...
                      Quem sangrou pra gente poder sorrir"<br></br>- BK
                    </p>
                  </div>
                  <div className={style.people}>
                    <img src={maicon} alt="" />
              ...
              <a
                href="https://www.instagram.com/viniciussribeir0/"
                target="_blank"
              >
                <div className={style["social-card"]}>
                  <img src={rate} alt="rate" />
              ...
              <a href="https://www.instagram.com/madu_goda/" target="_blank">
                <div className={style["social-card"]}>
                  ...
                  <div className={style["social-quote"]}>
                    <p>
                      "Não importa o que você seja, quem você seja, ou que
                      deseja na vida, a ousadia em ser di ferente reflete na sua
                      personalidade, no seu caráter, naquilo que você é. E é
                      assim que as pessoas lembrarão de você um dia." <br></br>{" "}
                      - Ayrton Senna
                    </p>
                  </div>
                  <div className={style.people}>
              ...
              <a href="https://www.instagram.com/ylan_costa/" target="_blank">
                <div className={style["social-card"]}>
                  ...
                  <div className={style["social-quote"]}>
                    <p>
                      “Os que vencem, não importa como vençam, nunca conquistam
                      a vergonha”. - Nicolau Maquiavel
                    </p>
                  </div>
                  <div className={style.people}>
                    <img src={Ilan} alt="" />
