...
import LeftText from "../components/landingPage/LeftText";
  ...
  return (
    <div className={style.body}>
      <div className="p-14">
        ...
        <LeftText
          text="Saiba o que está acontecendo ao redor do mundo."
          img={MapaMundi}
        />

        <RightText
          text="Nunca houve uma maneira tão fácil de fazer conteúdos criativos e atuais."
          subtext="Foque suas energias no que realmente tem público."
          img={User}
        />

        <LeftText
          text="Descobrir qual é a próxima grande tendência nos diz em que focar"
          img={Filmes}
        />

        <RightText
          text="Acesse as informações mais relevantes, o que é popular."
          subtext={"Acesso a todos os trending topics nas redes sociais"}
          img={home}
        />
        ...
        <div className="pb-8 text-xl">
          <footer>© 2024 TrendyPro | All Rights Reserved</footer>
        </div>
      </div>
    </div>
  );
