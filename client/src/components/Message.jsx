  ...
  return (
    <div className="flex justify-center mt-24">
      <div className="flex-col ">
        {props.robot == "normal" ? (
          <>
            <img loading="lazy" src={normalRobot} className="mx-auto" alt="" />
          ...
          <>
            <img loading="lazy" src={sadRobot} className="mx-auto" alt="" />
            <p className="text-3xl pb-5 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
              {props.message}
            </p>
          </>
          ...
          <>
            <img loading="lazy" src={deadRobot} className="mx-auto" alt="" />
            <p className="text-3xl pb-5 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
              {props.message}
            </p>
          </>
          ...
          <>
            <img loading="lazy" src={friendlyRobot} className="mx-auto" alt="" />
            <p className="text-3xl pb-5 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
              {props.message}
            </p>
